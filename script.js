    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: '4f51a3b4-35f1-4ca0-8569-8aae3721a59a',
            name: name,
            email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Horse Whisperer משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
